...
DEFAULT_CLIENTS = ["0","1", "2", "3", "4", "5", "6","8"]
...
def start_clients(server_address: str, clients: list[str]):
    ...
    # Environment variable to ensure the client can find 'model' and 'data' modules
    env = os.environ.copy()
    ...
    for cid in clients:
        ...
        # We pass the full path to the dataset directly
        cmd = [
        ...
        print(f"Started Client {cid} (PID: {proc.pid}) -> Log: logs/client_{cid}.log")
